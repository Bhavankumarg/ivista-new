...
<Container fluid className="bg-white p-0 pb-5 p-2 ">
  ...
  <Container className="iv-bg pt-5 mt-5 pb-5 rounded-5 mx-auto p-lg-4">
    ...
    <Container className="py-2">
      <ul className="fs-5 text-white para-text px-lg-4">
        ...
        <li className="pt-2">
          ...
          <span className="fw-light">
            ...
            Execution, Analytics and Reporting, <br/>and Stakeholder
            Coordination
          </span>
        </li>
        <li className="pt-2">
          <span className="fw-bold">Domain Expertise:</span>{" "}
          <span className="fw-light">
            Technology, E-Commerce, Education, Social Impact, D2C,
      ...
      <p className="text-white para-text px-lg-4 fs-5 text-start">
        ...
        maintaining project momentum, and delivering outcomes aligned with
  ...
  <Container className="iv-bg-white pt-5 mt-5 pb-5 rounded-5 mx-auto p-lg-4">
    ...
    <Container className="py-2">
      ...
      <p className="text-black para-text px-lg-4 fs-5 text-start">
        ...
        connections—whether it’s a landing page, campaign, or full-fledged
        website
      </p>
    </Container>
  </Container>
  <Container className="iv-bg pt-5 mt-5 pb-5 rounded-5 mx-auto p-lg-4">
    ...
    <Container className="py-2">
      ...
      <p className="text-white para-text px-lg-4 fs-5 text-start">
        With deep experience in designing for luxury brands, our UI/UX
        specialists will ensure every touchpoint reflects the refined
        personality of Maidens Hotel—while maintaining intuitive user
        flows and mobile-first responsiveness
      </p>
    </Container>
  </Container>
  {/* SEO Team */}
    ...
    <Container className="py-2">
      <ul className="fs-5 text-black para-text px-lg-4">
        ...
        <li className="pt-2">
          ...
          <span className="fw-light">
            On-Page SEO, Technical SEO, Local SEO, and Paid Media Strategy
            Across LinkedIn, Meta, and Google
          </span>
        </li>
        <li className="pt-2">
          <span className="fw-bold">Industries Covered: </span>{" "}
          <span className="fw-light">
            Technology, E-Commerce, Education, Social Impact, D2C,
            Finance, and Real Estate
          </span>
      ...
      <p className="text-black para-text px-lg-4 fs-5 text-start">
        Our performance team will ensure the site is discoverable,
        indexable, and conversion-ready from day one. SEO best practices
        will be integrated from design to deployment
      </p>
    </Container>
  </Container>
  {/* Development Team */}
      ...
      <ul className="fs-5 text-white para-text px-lg-4">
        ...
        <li className="pt-2">
          ...
          <span className="fw-light">
            ...
            CSS, Sitecore XP, REST API, PHP, .NET, MySQL, MongoDB, Python,
            Shopify, WordPress, Cloud Platforms (AWS, Azure, Google
        ...
        <li className="pt-2">
          <span className="fw-bold">Certifications: </span>{" "}
          <span className="fw-light">
            Sitecore Developer Certification (.NET & XP), React Developer
            Certification, Laravel & MERN Stack
          </span>
        </li>
        <li className="pt-2">
          <span className="fw-bold">Domain Expertise: </span>{" "}
